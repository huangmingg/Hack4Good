...
<v-sheet>
    <v-toolbar-title class="head">
      ...
      mdi-chart-bar
        ...
        <div class="main">
            <li v-for="stock in stocks" :key="stock.shop_id" @click="handleClick(stock)"> 
    ...
    async retrieveStockLevel() {
      ...
      .then((res) => {
        ...
        for (var i = 0; i < res.message.length; i++) {
            ...
            var shopID = res.message[i].shop_id;
            ...
            this.stocks.push({"shop_id" : shopID, "shop_name" : shopName, "items" : expiringItems});
        }
